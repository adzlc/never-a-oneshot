...
const navigationMenuTriggerStyle = cva(
  `text-primary text-sims group inline-flex h-10 w-max items-center justify-center rounded-md bg-white px-4 py-2 
   text-2xl font-medium transition-colors hover:bg-slate-100 focus:bg-slate-100
    focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-slate-100/50 data-[state=open]:bg-slate-100/50
     dark:bg-slate-950 dark:hover:bg-slate-800 dark:hover:text-slate-50 dark:focus:bg-slate-800 dark:focus:text-slate-50
